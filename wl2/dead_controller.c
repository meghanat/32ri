...
int main(int argc,char *argv[])
{
	...
	f = fopen("../input2.1_32/wl2/starttime.txt", "r");
	f1 = fopen("../input2.1_32/wl2/cpu_time.txt", "r");
	f2 = fopen("../input2.1_32/wl2/core_request.txt","r");
	f3 = fopen("../input2.1_32/wl2/sleep_time.txt","r");
	f4 = fopen("../input2.1_32/wl2/job_id.txt","r");
	f5 = fopen("../input2.1_32/wl2/task_index.txt","r");
		
	f6 = fopen("../input2.1_32/wl2/exec_time.txt","r");
	printf("files opened\n");	
...
//		printf("\nexectime: %s\t starttime :%s\t cycles : %s\t utilization : %s sleep_time : %s\n",exec_time,line,cpu_time,core_request,sleep_time);
		...
		if(pid==0)
		{
			...
			if(execl("./dead_emulate_job",core_request,cpu_time,taskId,sleep_time,jobId,taskId,line,exec_time,argv[2],argv[3],NULL)==-1)//change
				perror("exec");
			printf("exec failed\n");
			exit(0);

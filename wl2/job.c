...
int main(int argc, char *argv[])
{
	...
	float scale_period=atof(argv[8]);
	float scale_runtime=atof(argv[9]);

	float runtime=atof(argv[1])/scale_runtime;
	float deadline=atof(argv[7])/scale_runtime;
	float period=deadline*scale_period;
	int ret;

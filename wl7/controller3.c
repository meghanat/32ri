...
int main(int argc,char *argv[])
{
	...
	f = fopen("../input2.1_32/wl7/starttime.txt", "r");
	f1 = fopen("../input2.1_32/wl7/cpu_time.txt", "r");
	f2 = fopen("../input2.1_32/wl7/core_request.txt","r");
	f3 = fopen("../input2.1_32/wl7/sleep_time.txt","r");
	f4 = fopen("../input2.1_32/wl7/job_id.txt","r");
	f5 = fopen("../input2.1_32/wl7/task_index.txt","r");
		
	f6 = fopen("../input2.1_32/wl7/exec_time.txt","r");
	printf("files opened\n");	

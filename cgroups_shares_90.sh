...
do
	...
	cgset -r cpu.shares=9216 group1
	...
	cd ..
	mv bg_resp.txt bg/cgroups_shares_90/bg_$bg_util.csv

	cd wl1
	mv wl_resp.txt cgroups_shares_90/fg_$bg_util.csv

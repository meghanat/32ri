...
do
	...
	cgset -r cpu.shares=1024 group1
...
do
	...
	cd ..
	mv bg_resp.txt bg/cgroups_quota_50/bg_$bg_util.csv

	cd wl1
	mv wl_resp.txt cgroups_quota_50/fg_$bg_util.csv
...
do
	...
	rm wl_resp.txt
	touch wl_resp.txt
	gcc controller3.c -o controller
	...
	cd ..
	mv bg_resp.txt bg/cgroups_quota_90/bg_$bg_util.csv

	cd wl1
	mv wl_resp.txt cgroups_quota_90/fg_$bg_util.csv
